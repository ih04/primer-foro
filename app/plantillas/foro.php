...
<form action="" method="POST"><input type="submit" value="hilo nuevo" name="hiloNuevo">
<div class="foro" name="divHilos"></form>
	<?php 
		$db=Conectate::GetInstance();
		$instancias=$db->select("select * from hilo");
		...
		if(count($instancias)>0){
			...
			echo "<p class='parrafo'>todavía no hay hilos en este foro</p>";
		}
